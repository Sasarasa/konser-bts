            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  ...
                  <p class="mb-4" data-aos="fade-up" data-aos-delay="200">Silahkan Registrasi untuk mendapatkan Nomor Tiket</p>
                  <p data-aos="fade-up" data-aos-delay="300"><a href="login.php" class="btn btn-primary py-3 px-5 btn-pill">Login</a></p>
                ...
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <?php
                  ?>
                  <form action="pro_reg.php" method="post" class="form-box">
                    <h3 class="h4 text-black mb-4">Registrasi disini</h3>
